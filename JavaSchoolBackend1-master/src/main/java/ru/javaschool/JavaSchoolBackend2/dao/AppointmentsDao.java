...
public class AppointmentsDao {
    ...
    public List<Appointment> findAllForPatient(String patientName) {
        Query query = entityManager.createQuery("From Appointment Where patient = " +
                patientsDao.findPatientByName(patientName));
        return query.getResultList();
    }
